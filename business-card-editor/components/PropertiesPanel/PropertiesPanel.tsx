          ...
          {el.type === 'text' && (
            <div style={{ marginBottom: '16px', paddingBottom: '16px', borderBottom: '1px solid #3a3a3a' }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 8, marginTop: 8 }}>
                <div>
                  <label style={{ fontSize: 11, color: '#888', display: 'block', marginBottom: 4 }}>Font Style</label>
                  <select value={(el.style as any)?.fontStyle ?? 'normal'} onChange={e => updateElement(selectedElements[0].pageId, el.id, { style: { ...(el.style as any), fontStyle: e.target.value } })} style={{ width: '100%', padding: 6, background: '#3a3a3a', color: '#fff', borderRadius: 4 }}>
                ...
                <div>
                  <label style={{ fontSize: 11, color: '#888', display: 'block', marginBottom: 4 }}>Text Align</label>
                  <select value={(el.style as any)?.textAlign ?? 'center'} onChange={e => updateElement(selectedElements[0].pageId, el.id, { style: { ...(el.style as any), textAlign: e.target.value } })} style={{ width: '100%', padding: 6, background: '#3a3a3a', color: '#fff', borderRadius: 4 }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 8, marginTop: 8 }}>
                <div>
                  <label style={{ fontSize: 11, color: '#888', display: 'block', marginBottom: 4 }}>Font Family</label>
                  <select value={(el.style as any)?.fontFamily ?? 'Inter, system-ui, -apple-system, "Segoe UI", Roboto, Helvetica, Arial'} onChange={e => updateElement(selectedElements[0].pageId, el.id, { style: { ...(el.style as any), fontFamily: e.target.value } })} style={{ width: '100%', padding: 6, background: '#3a3a3a', color: '#fff', borderRadius: 4 }}>
                ...
                <div>
                  <label style={{ fontSize: 11, color: '#888', display: 'block', marginBottom: 4 }}>Font Weight</label>
                  <select value={String((el.style as any)?.fontWeight ?? '400')} onChange={e => updateElement(selectedElements[0].pageId, el.id, { style: { ...(el.style as any), fontWeight: e.target.value } })} style={{ width: '100%', padding: 6, background: '#3a3a3a', color: '#fff', borderRadius: 4 }}>
